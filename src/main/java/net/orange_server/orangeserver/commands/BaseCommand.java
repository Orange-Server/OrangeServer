...
public abstract class BaseCommand {
    ...
    public boolean run(OrangeServer plugin, CommandSender sender, String cmd, String[] preArgs) {
        if (name == null) {
    ...
    protected List<String> tabComplete(OrangeServer plugin, final CommandSender sender, String cmd, String[] preArgs) {
        return null;
    }
